...
for z= 0%:5
    ...
    I     = 51; % Number of intervals in base case
    ...
    i=len_T;
    figure
    semilogx(x(1:2:end),N1(i,1:2:end),'bo--','linewidth',1.5,'markersize',11)
    hold on
    semilogx(x(1:2:end),N2(i,1:2:end),'rs--','linewidth',1.5,'markersize',11)
%    semilogx(x,N3(i,:),'^-','markersize',12)
    semilogx(x(1:2:end),N4(i,1:2:end),'m^--','linewidth',1.5,'markersize',11)
