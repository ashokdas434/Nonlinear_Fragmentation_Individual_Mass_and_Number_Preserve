...
for z= 0%:5
    ...
    if example == 1
        ...
        T = 1.75;% 0.85;  %0.4;%   [sec] Process time
    end
    len_T = 101;
    ...
    save(['Lin_grid-Ex-',num2str(example),'-Grid_mul-',num2str(grid_mul),'.mat'],'x','del_x','N_MC','N_NPMC','N_cons','N_ANA')
